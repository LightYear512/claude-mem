...
const HIGH_PRIORITY_PATTERNS = [
  ...
  /^services\/sqlite\/(?!types\.ts$|index\.ts$|ai-analysis\.ts$|ai-analysis\/(?:types|get)\.ts$|work-context\/(?:types|module-inference)\.ts$)/,  // SQLite services (exclude re-export, pure data, and pure utility files)
  /^services\/sync\//,
