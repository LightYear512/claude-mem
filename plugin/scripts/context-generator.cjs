...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},l=new H;var yt={};function bt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,pe.fileURLToPath)(yt.url))}var Ot=bt(),I=C.get("CLAUDE_MEM_DATA_DIR"),W=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,de.homedir)(),".claude"),Ht=(0,h.join)(I,"archives"),Wt=(0,h.join)(I,"logs"),Yt=(0,h.join)(I,"trash"),Vt=(0,h.join)(I,"backups"),qt=(0,h.join)(I,"modes"),Kt=(0,h.join)(I,"settings.json"),le=(0,h.join)(I,"claude-mem.db"),Jt=(0,h.join)(I,"vector-db"),zt=(0,h.join)(I,"observer-sessions"),Qt=(0,h.join)(W,"settings.json"),Zt=(0,h.join)(W,"commands"),es=(0,h.join)(W,"CLAUDE.md");function me(r){(0,ce.mkdirSync)(r,{recursive:!0})}function ue(){return(0,h.join)(Ot,"..")}var $=class{db;constructor(e=le){e!==":memory:"&&me(I),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createAIAnalysisTable(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
