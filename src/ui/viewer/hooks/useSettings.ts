    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_GEMINI_API_URL: data.CLAUDE_MEM_GEMINI_API_URL || DEFAULT_SETTINGS.CLAUDE_MEM_GEMINI_API_URL,
          ...
          CLAUDE_MEM_DASHSCOPE_API_KEY: data.CLAUDE_MEM_DASHSCOPE_API_KEY || DEFAULT_SETTINGS.CLAUDE_MEM_DASHSCOPE_API_KEY,
          CLAUDE_MEM_DASHSCOPE_MODEL: data.CLAUDE_MEM_DASHSCOPE_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_DASHSCOPE_MODEL,
